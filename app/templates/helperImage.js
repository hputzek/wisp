...
(function() {
    module.exports.register = function(Handlebars, options) {
        ...
        Handlebars.registerHelper("image", function(title, path, sizes) {
           ...
           var settings = grunt.file.readYAML('app/templates/data/settings.yml');
            ...
            var html = '';
            for (index = 0; index < imgSizes.length; ++index) {
                html += '<img src="'+ imgPhpScriptPath + '?src=' + imgPath + path +  '&w=' + imgSizes[index] + '&hash=' + getHash(index) + '" title="' + title + '" />';
            }
            function getHash(index){
                return md5('src=' + imgPath + path + '&w=' + imgSizes[index] + imgHashPassphrase );
            }
            return html;
        });
    };
